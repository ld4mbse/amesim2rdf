...
#filePaths = ["C:/Users/rb16964/git/amesim2rdf/amesim2rdf/amesimmodels/BrakingSystem.ame"]
...
for filePath in filePaths:
	if filePath.endswith(".ame"):
		print filePath
		
		AMEOpenAmeFile(filePath)
		model_name = AMEGetActiveCircuit()	
		print model_name		
		#model_name = file
		unique_name_parts = filePath.split('\\')
